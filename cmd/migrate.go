...
/**
 * usage:
 * look version: `pcrs migrate look --database sqlserver://PowerCalc:Power%401433@10.35.83.61:1433?database=PowerCalcFor46  --source file://scripts`
 * up:           `pcrs migrate up 1 --database sqlserver://PowerCalc:Power%401433@10.35.83.61:1433?database=PowerCalcFor46  --source file://scripts`
 * down:         `pcrs migrate down 1 --database sqlserver://PowerCalc:Power%401433@10.35.83.61:1433?database=PowerCalcFor46  --source file://scripts`
 */
